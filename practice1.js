...
// one more time, expected result when console.log(name) should be "jsfor.qa"


// ЗАДАЧИ СО ЗВЕЗДОЧКОЙ =) 
// Для тех кто хочет попрактиковаться в знаниях, которые, возможно, имеет и решить простые задачи из тем, которые будут далее и познакомиться с нативными объектами и функциями (мы их немного рассмотрели в типах уже):
